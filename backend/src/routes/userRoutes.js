...
router.put('/recruiter-profile-update', VerifyToken, authorizedRoles("recruiter"), uploadMiddleware, recruiterProfileSetup);

// SET Candidate PROFILE
router.put('/candidate-profile-update', VerifyToken, authorizedRoles("candidate"), uploadMiddleware, candidateProfileSetup);
